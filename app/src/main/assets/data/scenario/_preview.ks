...
[chara_show  name="alyona.kapitonova"  time="10"  wait="true"  storage="chara/2/siluet.png"  width="213"  height="442"  left="424"  top="266"  reflect="false"  ]
[mask_off time=10]
*domofon

[glink  color="black"  storage="chapter2.ks"  size="20"  text="Это&nbsp;Виталя"  target=""  x="360"  y="687"  width=""  height=""  _clickable_img=""  ]
